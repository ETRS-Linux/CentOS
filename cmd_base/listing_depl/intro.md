...
<p>Bonjour et bienvenue dans ce scénario pour vous aider à maîtriser les commande <span style="background-color:#dcdcdc; border-radius: 3px;"><code>ls</code></span> et <span style="background-color:#dcdcdc; border-radius: 3px;"><code>cd</code></span> sur Linux</p>
